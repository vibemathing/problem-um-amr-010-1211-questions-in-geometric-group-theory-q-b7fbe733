...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-1211-questions-in-geometric-group-theory-q-b7fbe733",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-1211-8279374c9e90",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-1211"
      }
    ],
    "statement": {
      "language": "en",
      "text": "(Grigorchuk) Aut(Fn) acts on the space ∂3Fn of triples of distinct ends of Fn. Denote by Yn the compact space (Cantor set) the quotient space of ∂3Fn by the group of inner automorphisms. Thus Out(Fn) acts on Yn. Describe the dynamics of this action; in particular the dynamics of any individual outer automorphism.",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 12.11",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "dfb77155b90112c301b2b7dd8136e5ca60df76d94262b978e07b2440e5ace2d8"
}
```
